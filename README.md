...
```bash
# Ubuntu / Debian / Mint
sudo apt install ./porkill_1.0.7_amd64.deb

# Fedora / RHEL / CentOS
sudo dnf install ./porkill-1.0.7-1.x86_64.rpm
```
...
```bash
wget https://github.com/a-issaoui/porkill/releases/latest/download/porkill-v1.0.7-x86_64.AppImage
chmod +x porkill-v1.0.7-x86_64.AppImage
./porkill-v1.0.7-x86_64.AppImage
```
